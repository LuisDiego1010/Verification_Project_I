...
El Test define las condiciones del escenario y el Generator genera las transacciones de forma aleatoria dentro de esos límites. El Agent las divide en dos: una va al Driver para ejecutarse y otra al Scoreboard para registrar lo esperado.

El Driver es el único que interactúa directamente con el DUT, colocando las transacciones en las FIFOs correspondientes y activando \texttt{pndng}. Estas FIFOs son parte del ambiente de verificación y no del DUT.

El Monitor observa las respuestas del DUT y registra cuándo llegan, además de identificar su origen según la interfaz que tenía el turno. Finalmente, el Checker compara lo esperado con lo observado para verificar el contenido, destino y latencia. Las aserciones complementan esta verificación al supervisar ciclo a ciclo el protocolo de la línea compartida.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{fig/ambiente.png}
